  ...
  return (
    <button
      className={`${className} rounded relative group lg:text-light lg:dark:text-dark
        text-lg py-2 px-4 min-h-[44px] flex items-center justify-center`}
      onClick={handleClick}
    >
      {title}
      <span
      ...
      <nav className="flex items-center justify-center mt-4 gap-2">
        <motion.a
          ...
          className="w-10 h-10 flex items-center justify-center rounded-full
            hover:bg-light/20 dark:hover:bg-dark/20 transition-colors"
          href={urls.twitter}
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          ...
          rel="noopener noreferrer"
          className="w-10 h-10 flex items-center justify-center rounded-full
            bg-light dark:bg-dark hover:bg-light/80 dark:hover:bg-dark/80 transition-colors"
          href={urls.github}
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
