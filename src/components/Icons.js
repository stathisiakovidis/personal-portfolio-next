...
export const FacebookIcon = ({ className, ...rest }) => (
  <svg 
    ...
    className={`w-full h-auto ${className}`}
  > 
    <path fill="#039BE5" d="M15 1A14 14 0 1 0 15 29A14 14 0 1 0 15 1Z"></path>
    ...
    <g><path fill="#4e7ab5" d="M15,2c7.168,0,13,5.832,13,13s-5.832,13-13,13S2,22.168,2,15S7.832,2,15,2 M15,1 C7.268,1,1,7.268,1,15s6.268,14,14,14s14-6.268,14-14S22.732,1,15,1L15,1z"></path></g>
  </svg>
);
